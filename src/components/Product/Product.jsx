...
const Product = ({ product }) => {
  ...
  return (
    <div>
      <div className="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto py-6 bg-white shadow-xl/20 rounded-xl border border-gray-100">
        {/* Card */}
        <div className="group flex flex-col">
          <div className="relative">
            ...
            <div className="pt-4">
              <h3 className="font-medium md:text-lg text-black">{title}</h3>
